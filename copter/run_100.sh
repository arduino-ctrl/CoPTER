...
do
    ...
    # python copter.py -p 5555 -e experiment_acc --online
    ...
    python copter.py -p 5556 -e experiment_copter_thesis -m CoPTER -f /home/ame/m3-main/parsimon-eval/expts/fig_8/analysis/fmaps_port_level_448ports/_thesis_mix_webserver_websearch --online
    # 计算命令执行时间
    end_time=$(date +%s)
